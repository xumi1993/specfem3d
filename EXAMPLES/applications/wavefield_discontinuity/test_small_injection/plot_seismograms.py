...
sec.plot_waveforms_fill('k', fig_num=fig.number, normalize=10.0, offset=offset, time_range=(-10.0, 40.0), fill=False, label="injection", linewidth=2)
sec_diff.plot_waveforms_fill('r--', fig_num=fig.number, normalize=100.0, offset=offset, norm_with=sec_fk, time_range=(-10.0, 40.0), fill=False, label="(injection-FK)X10", linewidth=2)
plt.ylim([-10.0, 40.0])
plt.xlim([0.0, 50.0])
